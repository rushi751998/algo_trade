from data import gc
data_sh = gc.open('Algo Dashboard').worksheet("alerts")


from stable_files.login import fyers
...
def getResetAlertList():
    ALERT_DF = pd.read_csv('alert_list.csv')
    ALERT_DF.set_index('SYMBOL',inplace =True)
    return ALERT_DF
...
if __name__ == "__main__":
    ...
    fyers.start_websocket(subscribe_callback=event_handler_quote_update,
